...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "ullash") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "Fahim") || (event.body.toLowerCase() == "ফাহিম")) {
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Ullash ッ❤️ তাকে সবাই XAIKO ★FAHIM নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami  fahim") || (event.body.toLowerCase() == "cup sala ami fahim") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস ফাহিম মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Fahim Ahmed") || (event.body.toLowerCase() == "@Mahira Jahan Mitu ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা 😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Mahira") || (event.body.toLowerCase() == "mim")) {
  ...
  if ((event.body.toLowerCase() == "@Raj Ahmed ") || (event.body.toLowerCase() == "raj")) {
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম হুম কইরো না মাথা এমনিতেই গরম আছে🤬⛏️😷", threadID);
   };

   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>ＦＡＨＩＭ ✨🔥", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tanja") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "AMAKE KEW VALOBASHE NA") || (event.body.toLowerCase() == "amake kew valobashe na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     return api.sendMessage("️চিন্তা করো কেন আমি ফাহিম তো আছি🫶/nতোমাকে রাইতে ভালোবাসবো", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে ফাহিম এর  ইনবক্সে চলে যা পাগল🌚🐸🌶️🍆", threadID);
   };
